...
values
    (7, '123-45-67890', '그린테크', '친환경 에너지 솔루션 기업', 'https://www.greentech.co.kr'),
    (8, '987-65-43210', '스타푸드', '프리미엄 간편식 제조업체', 'https://www.starfood.com'),
    (9, '456-12-78901', '디지털웨이브', 'AI 기반 소프트웨어 개발사', 'https://www.digitalwave.ai'),
    (10, '321-54-98765', '메디헬스', '의료기기 및 헬스케어 전문기업', 'https://www.medihealth.co.kr'),
    (11, '654-32-10987', '에코빌더스', '스마트 건축·인테리어 회사', 'https://www.ecobuilders.com');
