const service = (()=>{
    ...
    return {getPopularCompany:getPopularCompany,getExperience:getExperience,getIntern:getIntern,getAlarm:getAlarm,setActive:setActive,setInactive:setInactive,getSupportList:getSupportList,getSupportDetail:getSupportDetail}
})();